...
import com.creativeitinstitute.storyviewrepo.roundcornerprogressbar.common.AnimatedRoundCornerProgressBar
...
//        val newRadius =
//            AppCompatResources.getDrawable(context, com.creativeitinstitute.storyviewrepo.R.drawable.frame)
        ...
        //  val d= listOf<Drawable>(newRadius,)


        layoutProgress.background =  ResourcesCompat.getDrawable(resources, R.drawable.frame, null)
